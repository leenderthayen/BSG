...
/**
 * Manager class dealing with the calculation of single particle states and the calculation of matrix elements
 */
class NuclearStructureManager {
  public:
     ...
     */
    void SetDaughterNucleus(int Z, int A, int dJ, double R, double excitationEnergy, double beta2, double beta4, double beta6);
    /**
     ...
     * @param beta6 beta6 deformation
     */
    void SetMotherNucleus(int Z, int A, int dJ, double R, double excitationEnergy, double beta2, double beta4, double beta6);
    /**
    ...
    /**
     * Calculate the @f[ ^{V/A}M_{KLs} @f] matrix element in the Behrens-Buehring formalism
     * 
     * @param V boolean for vector (true) or axial vector (false) matrix element type
     ...
     */
    void AddOneBodyTransition(double obdme, int dKi, int dKf, SingleParticleState spsi, SingleParticleState spsf);
