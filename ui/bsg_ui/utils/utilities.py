...
robtdFile=None, **kwargs):
    ...
    config.set('Transition', 'QValue', str(Q))
    if phl:
        config.set('Transition', 'PartialHalflife', str(phl))
    if logft:
        config.set('Transition', 'LogFt', str(logft))
    if robtdFile:
        config.set('Transition', 'ROBTDFile', robtdFile)
    config.set('Mother', 'Z', str(Zm))
    config.set('Mother', 'A', str(A))
    config.set('Mother', 'Radius', str(mRad))
    config.set('Mother', 'Beta2', str(beta2m))
    config.set('Mother', 'Beta4', str(beta4m))
    config.set('Mother', 'Beta6', str(beta6m))
    config.set('Mother', 'SpinParity', str(mJpi))
    config.set('Mother', 'ExcitationEnergy', str(mE))
    config.set('Daughter', 'Z', str(Zd))
    config.set('Daughter', 'A', str(A))
    config.set('Daughter', 'Radius', str(dRad))
    config.set('Daughter', 'Beta2', str(beta2d))
    config.set('Daughter', 'Beta4', str(beta4d))
    config.set('Daughter', 'Beta6', str(beta6d))
    config.set('Daughter', 'SpinParity', str(dJpi))
    config.set('Daughter', 'ExcitationEnergy', str(dE))
